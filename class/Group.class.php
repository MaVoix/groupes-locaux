<?php	/**
	...
	*/
	...
	private $nPosters;
	private $nBallots;
	private $nAccounting_expenses;
	private $nPosters_cost;
	private $nProfessions_de_foi_cost;
	private $nBallots_cost;
	...
	*/
	public function save()
	{
		...
		if(isset($this->aDataSet["accounting_expenses"]))
		{
			$aData["accounting_expenses"]=$this->getAccounting_expenses();
		}

		if(isset($this->aDataSet["posters_cost"]))
		{
			$aData["posters_cost"]=$this->getPosters_cost();
		}

		if(isset($this->aDataSet["professions_de_foi_cost"]))
		{
			$aData["professions_de_foi_cost"]=$this->getProfessions_de_foi_cost();
		}

		if(isset($this->aDataSet["ballots_cost"]))
		{
			$aData["ballots_cost"]=$this->getBallots_cost();
		}
	...
	*/
	private function vide()
	{
		...
		$this->setAccounting_expenses(0);
		$this->setPosters_cost(0);
		$this->setProfessions_de_foi_cost(0);
		$this->setBallots_cost(0);
		$this->setEmailing_expenses(0);
	...
	*/
	...
	$aObjet = [
		...
		"accounting_expenses" => $this->getAccounting_expenses(),
		"posters_cost" => $this->getPosters_cost(),
		"professions_de_foi_cost" => $this->getProfessions_de_foi_cost(),
		"ballots_cost" => $this->getBallots_cost(),
	...
	*/
	...
	/**
	* Set le champ accounting_expenses
	* @param numeric $nAccounting_expenses nouvelle valeur pour le champ accounting_expenses
	*/
	public function setAccounting_expenses($nAccounting_expenses)
	{
		if( is_null($nAccounting_expenses) ) $nAccounting_expenses='';
		if( is_numeric($nAccounting_expenses)  || $nAccounting_expenses=='' )
		{
			$this->nAccounting_expenses = $nAccounting_expenses;
			$this->aDataSet["accounting_expenses"]=1;
		}
	}
	...
	/**
	* Get le champ accounting_expenses
	* @return numeric valeur du champ accounting_expenses
	*/
	public function getAccounting_expenses()
	{
		if( !is_null($this->nAccounting_expenses) )
		{
			if( $this->nAccounting_expenses==='' )
			{
				 return NULL;
			}
			else
			{
				 return $this->nAccounting_expenses;
			}
		}
		else
		{
			$this->hydrateFromBDD(array('accounting_expenses'));
			$this->callHydrateFromBDDOnGet++;
			if($this->callHydrateFromBDDOnGet>10)
			{
				echo "<br />WARNING : trop d'appel en base depuis l'accesseur ". __CLASS__ ."::". __FUNCTION__ ."";
	...
	/**
	* Set le champ posters_cost
	* @param numeric $nPosters_cost nouvelle valeur pour le champ posters_cost
	*/
	public function setPosters_cost($nPosters_cost)
	{
		if( is_null($nPosters_cost) ) $nPosters_cost='';
		if( is_numeric($nPosters_cost)  || $nPosters_cost=='' )
		{
			$this->nPosters_cost = $nPosters_cost;
			$this->aDataSet["posters_cost"]=1;
		}
	}
	...
	/**
	* Get le champ posters_cost
	* @return numeric valeur du champ posters_cost
	*/
	public function getPosters_cost()
	{
		if( !is_null($this->nPosters_cost) )
		{
			if( $this->nPosters_cost==='' )
			{
				 return NULL;
			}
			else
			{
				 return $this->nPosters_cost;
			}
		}
		else
		{
			$this->hydrateFromBDD(array('posters_cost'));
			$this->callHydrateFromBDDOnGet++;
			if($this->callHydrateFromBDDOnGet>10)
			{
				echo "<br />WARNING : trop d'appel en base depuis l'accesseur ". __CLASS__ ."::". __FUNCTION__ ."";
	...
	/**
	* Set le champ professions_de_foi_cost
	* @param numeric $nProfessions_de_foi_cost nouvelle valeur pour le champ professions_de_foi_cost
	*/
	public function setProfessions_de_foi_cost($nProfessions_de_foi_cost)
	{
		if( is_null($nProfessions_de_foi_cost) ) $nProfessions_de_foi_cost='';
		if( is_numeric($nProfessions_de_foi_cost)  || $nProfessions_de_foi_cost=='' )
		{
			$this->nProfessions_de_foi_cost = $nProfessions_de_foi_cost;
			$this->aDataSet["professions_de_foi_cost"]=1;
		}
	}
	...
	/**
	* Get le champ professions_de_foi_cost
	* @return numeric valeur du champ professions_de_foi_cost
	*/
	public function getProfessions_de_foi_cost()
	{
		if( !is_null($this->nProfessions_de_foi_cost) )
		{
			if( $this->nProfessions_de_foi_cost==='' )
			{
				 return NULL;
			}
			else
			{
				 return $this->nProfessions_de_foi_cost;
			}
		}
		else
		{
			$this->hydrateFromBDD(array('professions_de_foi_cost'));
			$this->callHydrateFromBDDOnGet++;
			if($this->callHydrateFromBDDOnGet>10)
			{
				echo "<br />WARNING : trop d'appel en base depuis l'accesseur ". __CLASS__ ."::". __FUNCTION__ ."";
	...
	/**
	* Set le champ ballots_cost
	* @param numeric $nBallots_cost nouvelle valeur pour le champ ballots_cost
	*/
	public function setBallots_cost($nBallots_cost)
	{
		if( is_null($nBallots_cost) ) $nBallots_cost='';
		if( is_numeric($nBallots_cost)  || $nBallots_cost=='' )
		{
			$this->nBallots_cost = $nBallots_cost;
			$this->aDataSet["ballots_cost"]=1;
		}
	}
	...
	/**
	* Get le champ ballots_cost
	* @return numeric valeur du champ ballots_cost
	*/
	public function getBallots_cost()
	{
		if( !is_null($this->nBallots_cost) )
		{
			if( $this->nBallots_cost==='' )
			{
				 return NULL;
			}
			else
			{
				 return $this->nBallots_cost;
			}
		}
		else
		{
			$this->hydrateFromBDD(array('ballots_cost'));
			$this->callHydrateFromBDDOnGet++;
			if($this->callHydrateFromBDDOnGet>10)
			{
				echo "<br />WARNING : trop d'appel en base depuis l'accesseur ". __CLASS__ ."::". __FUNCTION__ ."";
	...
	* @param numeric $nEmailing_expenses nouvelle valeur pour le champ emailing_expenses
	*/
	...
	* @return numeric valeur du champ emailing_expenses
	*/
    ...
    */
    ...
    {
        return
        $this->getSmall_expenses()
        +$this->getEmailing_expenses()
        +$this->getBanking_fees()
        +$this->getPost_expenses()
        +$this->getAccounting_expenses();
    }
